...
class Boleite::ShaderException < Exception
...
struct Boleite::ShaderDepthSettings
  enum Function
    Always
    Never
    Less
...
class Boleite::ShaderParser
  ...
  @shader_sources = StaticArray(String, SHADER_TYPE_COUNT).new("")
