class Boleite::GUI
  ...
  class DefaultDesign < Design
    class ButtonDesign < DesignDrawer
      struct ButtonDrawables
      ...
      @cache = DrawableCache(ButtonDrawables).new do |widget|
        ButtonDrawables.new
      end
